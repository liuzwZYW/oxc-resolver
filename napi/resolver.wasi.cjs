...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = __nodePath.resolve('@my-oxc-resolver-test/binding-wasm32-wasi')
  } catch {
    throw new Error('Cannot find resolver.wasm32-wasi.wasm file, and @my-oxc-resolver-test/binding-wasm32-wasi package is not installed.')
  }
}
