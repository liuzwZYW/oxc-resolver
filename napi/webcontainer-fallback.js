...
const bindingEntry = `${baseDir}/node_modules/@my-oxc-resolver-test/binding-wasm32-wasi/resolver.wasi.cjs`;

if (!fs.existsSync(bindingEntry)) {
  fs.rmSync(baseDir, { recursive: true, force: true });
  fs.mkdirSync(baseDir, { recursive: true });
  const bindingPkg = `@my-oxc-resolver-test/binding-wasm32-wasi@${version}`;
